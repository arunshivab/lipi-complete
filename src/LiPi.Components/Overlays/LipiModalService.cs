...
public sealed class LipiModalService : ILipiModalService
{
        ...
        string?       cancelLabel  = null)
    {
        ...
        var req = new ModalRequest
        {
            ...
            ComponentType = typeof(LiPi.Components.Overlays.ConfirmDialog),
        ...
        string?     okLabel = null)
    {
        ...
        var req = new ModalRequest
        {
            ...
            CloseOnBack   = false,
            ComponentType = typeof(LiPi.Components.Overlays.AlertDialog),
            Parameters    = new Dictionary<string, object?>
            {
                ["Message"] = message,
                ["Intent"]  = intent,
        ...
        bool    required     = true)
    {
        ...
        var req = new ModalRequest
        {
            ...
            CloseOnEsc    = true,
            CloseOnBack   = false,
            ComponentType = typeof(LiPi.Components.Overlays.PromptDialog),
            Parameters    = new Dictionary<string, object?>
            {
                ["Label"]        = label,
